...
@section('content')
    <div class="w-[95%] m-auto max-h-screen overflow-visible mt-20">
       <div class="w-full bg-white">
            <span class=" text-blue-900 flex justify-center items-center text-2xl font-bold">
                Mes évaluations
            </span>
            <div class="flex justify-end items-center w-full p-5">               
                    <a href="{{route('EnseignantCreeEvaluation')}}" class="font-bold text-md p-2 rounded-full bg-blue-900 text-white">Ajouter une évaluation</a>
            </div>
