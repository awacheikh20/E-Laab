...
<head>
    ...
    <title>E-laab | Administration</title>
</head>
<body class="h-screen ">
    @if (Auth()->user()->status == 'admin')
        <div class="flex bg-gray-100 justify-end items-start w-full relative h-screen">
             <div class="bg-white  w-[10%] h-screen fixed left-0">
                 <div class="pt-20 text-blue-800 ">
                     ...
                     <a class="" href="{{route('AdminDashboard')}}">
                         <div  class=" h-10 flex justify-center items-center text-center  hover:bg-gray-100 hover:text-white hover:rounded-l-full font-bold text-lg">
                             Dashboard
                         </div>
                     </a>
             ...
             <div class="flex justify-end items-center w-[90%]  h-full ">
                 @yield('content')
             </div>
        </div>
    @else
